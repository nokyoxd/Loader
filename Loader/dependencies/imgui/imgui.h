...
namespace ImGui
{
    ...
    IMGUI_API bool          Category(const char* label, const ImVec2& size_arg, bool state, int x = 18, int y = 7);
...
enum ImGuiWindowFlags_
{
    ...
    ImGuiWindowFlags_WindowFlags            = ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoScrollWithMouse | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoBackground,
